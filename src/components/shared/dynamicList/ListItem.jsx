    ...
    <div className="flex justify-between items-center ">
      <div className="flex-1 simple-input">
        <div className="flex  overflow-hidden gap-2">
          {/* number */}
          <div className="  text-lg font-bold flex justify-center items-center flex-col gap-2">
            <span className="rounded p-2 inline-block w-full text-center bg-contract">{index + 1}</span>
            {styleType == 2 && (
              <>
                {/* add item btn */}
                {multi && last && (
